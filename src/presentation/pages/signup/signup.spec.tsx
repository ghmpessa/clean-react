...
describe('SignUp Component', () => {
  ...
  test('Should show correct password error if Validation fails', () => {
    const validationError = faker.random.words()
    makeSut({ validationError })
  ...
  test('Should show correct passwordConfirmation error if Validation fails', () => {
    const validationError = faker.random.words()
    makeSut({ validationError })
  ...
  test('Should go to sign up page', () => {
    makeSut()
    const backLogin = screen.getByTestId('login-link')
